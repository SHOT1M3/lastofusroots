...
switch(l2697BE31_0)
{
	...
	/// @DnDParent : 2697BE31
	/// @DnDArgument : "const" "spr_player_new_run"
	case spr_player_new_run:
		...
		if(vel_x == 0)
		{
			...
			/// @DnDParent : 41966973
			/// @DnDArgument : "value" "spr_player_new_idle"
		...
		if(vel_y > 1)
		{
			...
			/// @DnDParent : 441861AA
			/// @DnDArgument : "spriteind" "spr_player_new_fall"
			/// @DnDSaveInfo : "spriteind" "spr_player_new_fall"
			sprite_index = spr_player_new_fall;
			image_index = 0;
		}
		break;
	...
	/// @DnDParent : 2697BE31
	/// @DnDArgument : "const" "spr_player_new_jump"
	case spr_player_new_jump:
		/// @DnDAction : YoYo Games.Common.If_Variable
		/// @DnDVersion : 1
		/// @DnDHash : 3EC5D8FB
	...
	/// @DnDParent : 2697BE31
	/// @DnDArgument : "const" "spr_player_new_fall"
	case spr_player_new_fall:
		...
		if(grounded)
		{
			...
			/// @DnDSaveInfo : "soundid" "snd_land_01"
	...
	/// @DnDParent : 2697BE31
	/// @DnDArgument : "const" "spr_player_new_hurt"
	case spr_player_new_hurt:
		/// @DnDAction : YoYo Games.Common.If_Expression
		/// @DnDVersion : 1
		/// @DnDHash : 12554785
		...
		if(grounded)
		{
			...
			/// @DnDSaveInfo : "objectid" "obj_effect_knockback"
